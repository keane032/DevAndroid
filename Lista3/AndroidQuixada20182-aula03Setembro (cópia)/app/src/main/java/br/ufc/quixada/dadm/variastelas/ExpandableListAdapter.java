...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    private List<br.ufc.quixada.dadm.variastelas.models.Contato> agenda;
...
//    }
    ...
    public ExpandableListAdapter(Context context, List<br.ufc.quixada.dadm.variastelas.models.Contato> all) {
        this.context = context;
        this.agenda = all;
    }
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        txViewContentEndereco.setText( contato.getEnde() );
        txViewContentTelefone.setText( contato.getPhone() );
    ...
    public long getGroupId( int groupPosition ) {
        return agenda.get( groupPosition ).getUid();
    }
